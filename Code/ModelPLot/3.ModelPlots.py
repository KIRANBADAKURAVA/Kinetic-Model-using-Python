...
file_path = r'C:\Users\kiran\OneDrive\Desktop\Model Repo\Kinetic-Model-using-Python\Data\CombinedData\CombinedData(0%).xlsx'  # Use raw string to handle backslashes
data = pd.read_excel(file_path)

# Add a new column for 1/Temp
data['1/Temp'] = 1 /( data['##Temp./°C']+273)
...
for alpha in alpha_values:
    ...
    sns.scatterplot(x=alpha_data['1/Temp'], y=alpha_data['lnB'], label=f'Alpha = {alpha}')
