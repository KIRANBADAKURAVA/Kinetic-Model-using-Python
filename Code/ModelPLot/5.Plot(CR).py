...
for alpha in alpha_values:
    ...
    sns.scatterplot(x=alpha_data['1/Temp'], y=alpha_data['ln(G/T)'], label=f'Alpha = {alpha}')
...
plt.ylabel('ln(G/T)')
plt.title('Linear Regression of lnB/T vs 1/Temperature for Different Alpha Values')
plt.legend()
plt.show()
